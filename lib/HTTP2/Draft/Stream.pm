...
HTTP2::Draft::Stream - The great new HTTP2::Draft::Stream!
...
Readonly our $STATE_RESERVED_LOCAL     => 1;
Readonly our $STATE_RESERVED_REMOTE    => 2;
Readonly our $STATE_OPEN               => 3;
Readonly our $STATE_HALF_CLOSED_REMOTE => 4;
Readonly our $STATE_HALF_CLOSED_LOCAL  => 5;
Readonly our $STATE_CLOSED             => 6;
